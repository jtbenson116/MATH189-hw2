...
#Axis names needed!!!
barplot(with(video_df, table(freq[video_df$freq==1], time[video_df$freq==1])), col="red")
barplot(with(video_df, table(freq[video_df$freq==2], time[video_df$freq==2])), col="blue")
barplot(with(video_df, table(freq[video_df$freq==3], time[video_df$freq==3])), col="orange")
barplot(with(video_df, table(freq[video_df$freq==4], time[video_df$freq==4])), col="green",)
...
time.means.by.freq
barplot(time.means.by.freq, col=c("red", "blue", "orange", "green"))
# FIX COLORS
